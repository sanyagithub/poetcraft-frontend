...
--
-- Host: localhost    Database: poetcraft_db
-- ------------------------------------------------------
...
CREATE TABLE `awards` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `award_image_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `award_title` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `awards` VALUES (1,'example.png','example','2024-06-27 17:49:29.788000',1,2,1);
...
INSERT INTO `courses` VALUES (1,'2024-07-09 11:25:05.000000','Learning Scansion of Meter','How to Scan a Poem?');
...
INSERT INTO `modules` VALUES (1,'2024-06-08 18:50:02.000000','Basic Introduction of Scansion and Syllables','Introduction to Scansion and Syllables',1),(2,'2024-06-11 10:38:06.000000','Understanding how to identify Stressed and Unstressed Syllables','Stressed and Unstressed Syllables',1),(3,'2024-06-11 10:38:06.000000','Understanding the different types of scansion, meter and feet','Tools and Techniques',1),(4,'2024-06-11 10:38:06.000000','Scanning Complete Poems using the three steps of Scansion','Scanning Poems',1);
...
CREATE TABLE `questions` (
  ...
  `drag_drop_syllables_correct` json DEFAULT NULL,
  `drag_drop_syllables_options` json DEFAULT NULL,
  `drag_drop_word` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `edges` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `syllable` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `type` enum('DRAG_DROP','MCQ','STRESS_CHECKER_POEM','STRESS_CHECKER_WORDS') COLLATE utf8mb4_general_ci NOT NULL,
  `audio_id` bigint DEFAULT NULL,
  `module_id` bigint NOT NULL,
  `poem_id` bigint DEFAULT NULL,
  `poem_syllables` json DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'2024-06-08 16:46:33.917000','user@example.com','$2a$10$WhHi3cGzGe.QTu9cSkb9rujGK8.Pajl2tTynwdPU3Zh1RNf3t39uK',NULL,0),(2,'2024-07-03 17:01:22.033000','testuser@example.com','$2a$10$rUZzTpOFE3iI7XAPgZaMluM6Y7UKb2T0Y/BbTMy2hMPa6hkHu0R7m',NULL,0),(3,'2024-07-03 17:05:16.608000','Sanya@monica.in','$2a$10$nf/UCwE5SjHRhIIRbExU.eC/JxikieBHHur0kRw.a6T17f1lP.SQW',NULL,0),(4,'2024-07-04 12:02:40.449000',NULL,NULL,'919711472692',1),(5,'2024-07-09 11:15:12.073000','User1@example.com','$2a$10$WiAppdZO78bVUwl5q9SI/.nP6Xpif63qKppLzaM3WCFkroH2TuIjm',NULL,0);
...
-- Dump completed on 2024-07-19 10:47:13
